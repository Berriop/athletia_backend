...
const authController = new AuthController_1.AuthController(registerUseCase, loginUseCase, getMeUseCase, updateProfileUseCase);
// Routes
...
authRouter.put('/profile', auth_middleware_1.authMiddleware, authController.updateProfile);
